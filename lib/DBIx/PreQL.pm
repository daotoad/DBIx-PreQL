...
Adtrack features many queries that are built based on a template and a
list of arguments.  As we move code out of Mason into Perl, we can improve
the readability and maintainability of these queries using this module.
